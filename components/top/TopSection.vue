    ...
    data: () => ({
      ...
      icons: [
        ...
        },
        {
          ...
          tooltip: 'See battery status from up to 4 connected controllers at the same time'
        },
        {
          ...
          tooltip: 'All connected controllers will turn OFF when your computer shuts down'
        }
      ]
    }),
    methods: {
